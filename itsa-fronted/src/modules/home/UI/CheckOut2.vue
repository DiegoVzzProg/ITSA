<template>
    ...
    <div
        ...
        <div
            class="border flex flex-col w-full max-w-md max-[1060px]:max-w-2xl gap-4 min-h-full grow shrink-0 max-[1060px]:pt-6">
            ...
            <FormToCreateClient v-if="!ClientData || Editar" @success="successEditClient" />
...
import { CostumersClass, IDeleteProductFromShoppingCart, IProceedToCheckout } from "../services/costumers-service";
...
const successEditClient = (value: boolean) =>{
    Editar.value = value;
}
