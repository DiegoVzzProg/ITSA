<template>
  <div class="flex w-full max-w-md h-full flex-col justify-center gap-3">
    <div class="flex flex-col gap-3 pb-6">
      ...
      <div class="flex flex-col gap-3">
        <div
          ...
          v-for="(item, index) in FormLogin.User"
          :key="index"
        >
          <input
            v-model="item.value"
      ...
      <div
        class="flex flex-row justify-end w-full px-[clamp(18px,3vw,28px)]"
        v-if="ForgotPassword"
      >
        <button
    ...
    <div class="flex w-full flex-col gap-3 pt-6">
      ...
      <button
        type="button"
        v-on:click="site.RedirectPage({ name: 'register' })"
