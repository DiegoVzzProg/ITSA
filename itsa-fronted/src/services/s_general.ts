...
export class c_general {
    static async fileEncrypted(
        ...
        return await dgav.apiRequest(`/public/archivo/${folder}/${filename}`, dgav.httpMethod.GET);
    };
    ...
    static async DownloadFile(arch: string) {
        ...
        //     responseType: 'blob',
        // });
        return await dgav.apiRequest(`/public/downloadfile/${arch}`, dgav.httpMethod.GET);
    };

    static async fn_l_paises() {
        return await dgav.apiRequest(`/public/countries`, dgav.httpMethod.GET);
    }
};