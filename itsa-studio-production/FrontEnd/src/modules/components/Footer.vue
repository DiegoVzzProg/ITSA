  ...
  <footer id="footer" class="flex flex-col w-full grow shrink-0 px-[clamp(18px,5vw,68px)] min-h-screen justify-end">
    <div class="flex flex-col items-center justify-center w-full h-full grow shrink-0">
      <p class="text-pretty text-[clamp(1rem,2.5vw,1.5rem)] w-full max-w-[700px] text-center">
        ...
        independent digital assets boutique run by IN THE SAME AGENCY
    ...
    <div
      ...
      <section class="flex flex-row max-[768px]:flex-col w-full md:max-w-[230px] lg:max-w-[230px] min-h-full gap-[7px]">
        <p
      ...
      <section class="flex flex-row max-[768px]:flex-col w-full md:max-w-[230px] lg:max-w-[230px] min-h-full gap-[7px]">
        ...
        <div class="flex flex-col find-us-description gap-[5px] ps-1">
          ...
          <a href="https://www.facebook.com/profile.php?id=61573692787271" class="hover:bg-[rgb(0,0,0)] hover:text-white transition-all"
            target="_blank">
            facebook
          </a>
          <a href="https://mx.pinterest.com/itsastudiomx/?actingBusinessId=1009299103898940371"
            class="hover:bg-[rgb(0,0,0)] hover:text-white transition-all" target="_blank">
            pinterest
          </a>
